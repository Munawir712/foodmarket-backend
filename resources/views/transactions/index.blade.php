            ...
            <div class="bg-white">
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        @forelse ($transactions as $item)
                            <tr>
                                ...
                                <td class="border px-6 py-4 text-center">
                                    <a href="{{ route('transactions.show', $item->id) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold rounded py-2 px-4 mx-2">
                                        View
                                    </a>
                        ...
                        @empty
                            <tr>
                                <td class="text-center border p-5" colspan="6">No Data</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
