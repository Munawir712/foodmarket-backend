            ...
            <div class="w-full rounded overflow-hidden shadow-lg px-6 py-6 bg-white">
                <div class="flex flex-wrap -mx-4 -mb-4 md:mb-0">
                    <div class="w-full md:w-1/6 px-4 mb-4 md:mb-0">
                        <img src="{{ $item->food->picturePath }}" alt="gambar" class="w-full rounded">
                    </div>
                    <div class="w-full md:w-5/6 px-4 mb-4 md-mb-0">
                        ...
                        <div class="flex flex-wrap mb-3">
                            <div class="w-5/6">
                                <div class="text-sm">Paymet URL</div>
                                <div class="text-lg">
                            ...
                            <div class="w-1/6">
                                ...
                                <div class="text-xl font-bold">
                                    <a href="{{ route('transactions.changeStatus', ['id'=> $item->id, 'status'=> 'ON_DELIVERY']) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold px2 rounded block text-center w-full mb-1">
                                        On Delivery
                                    </a>
                                    <a href="{{ route('transactions.changeStatus', ['id'=> $item->id, 'status'=> 'DELIVERED']) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold px2 rounded block text-center w-full mb-1">
                                        Delivered
                                    </a>
                                    <a href="{{ route('transactions.changeStatus', ['id'=> $item->id, 'status'=> 'CANCELLED']) }}" class="bg-red-500 hover:bg-red-700 text-white font-bold px2 rounded block text-center w-full mb-1">
                                        Cancelled
                                    </a>
                                </div>
                            </div>
