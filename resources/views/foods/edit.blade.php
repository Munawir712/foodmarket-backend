    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form action="{{ route('foods.update', $item->id) }}" class="w-full" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="flex  flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="text" id="grid-last-name" value="{{ old('name') ?? $item->name }}" name="name" placeholder="Food Name" class="apperance-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4">
                        </div>
                    </div>
                    <div class="flex  flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                    ...
                    <div class="flex  flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="text" id="grid-last-description" value="{{ old('description') ?? $item->description }}" name="description" placeholder="Food description" class="apperance-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4">
                        </div>
                    </div>
                    <div class="flex  flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="text" id="grid-last-ingredients" value="{{ old('ingredients') ?? $item->ingredients }}"  name="ingredients" placeholder="Food Ingredients" class="apperance-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4">
                    ...
                    <div class="flex  flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="number" id="grid-last-price" value="{{ old('price') ?? $item->price }}" name="price" placeholder="Food price" class="apperance-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4">
                    ...
                    <div class="flex  flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="number" id="grid-last-rate" value="{{ old('rate') ?? $item->rate }}" name="rate" step="0.01" max="5" placeholder="Food rate" class="apperance-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4">
                        </div>
                    </div>
                    ...
                    <div class="flex  flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="text" id="grid-last-types" value="{{ old('types') ?? $item->types }}" name="types" placeholder="Food Types" class="apperance-none block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4">
